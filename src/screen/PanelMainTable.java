...
public class PanelMainTable extends JPanel implements Constants {
	private static final long serialVersionUID = 1L;
	 ...
	 protected void paintComponent(Graphics g) {
	     super.paintComponent(g);	
			...
			paintCells("right", g); // обводки правого игрока
	}
	...
	public void setFocusOnCard(int x, int y, Graphics g){
		g.setColor(Color.RED);
		g.drawRoundRect(x, y, FIELD_WIDTH, FIELD_HEIGHT, FIELD_WIDTH/dA, FIELD_HEIGHT/dA); // обводка левой колоды
	}
